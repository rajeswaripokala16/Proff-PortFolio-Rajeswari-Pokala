...
export default function Portfolio() {
  ...
  const handleSubmit = (e) => {
    ...
    window.open(
      `https://mail.google.com/mail/?view=cm&fs=1&to=rajeswaripokala16@gmail.com&su=${subject}&body=${body}`,
      '_blank'
    );
    
    setFormStatus('✓ Gmail opened in new tab! Please send the message.');
      ...
      <section id="contact" className={`py-20 px-4 transition-all duration-500 ${sectionBlink === 'contact' ? 'animate-pulse bg-purple-900/20' : ''}`}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            <div
              onClick={() => {
                window.open('https://mail.google.com/mail/?view=cm&fs=1&to=rajeswaripokala16@gmail.com', '_blank');
              }}
              className={`${currentTheme.card} backdrop-blur-lg rounded-2xl p-8 ${currentTheme.cardHover} transition-all transform hover:scale-105 hover:shadow-2xl cursor-pointer`}
            >
              ...
              <p className="text-xs text-purple-400 text-center mt-2">Click to compose email</p>
            </div>
